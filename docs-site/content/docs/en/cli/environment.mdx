...
| Variable     | Effect                                                                                                                                                                                                                                                     |
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `UC_PROFILE` | Run under a named profile, isolating the data dir, log dir, keychain entry, and iroh identity. The environment equivalent of [`--profile`](../cli/getting-started#global-flags). For example `UC_PROFILE=dev` stores under `app.clipboard.desktop-dev`. |
...
| `UC_DAEMON_RUN_MODE`          | Spawn contract for the background daemon: `server` selects the headless server-node mode (which also disables the system clipboard). From the terminal prefer [`clip start --server`](../cli/getting-started#daemon-lifecycle), which sets it for you.                                                            |
...
| Variable         | Effect                                                                                                                                                                                                                                                                                                                                 |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `RUST_LOG`       | Standard tracing filter; **overrides `UC_LOG_PROFILE`** when set. Accepts a level (`RUST_LOG=debug`) or per-module directives (`RUST_LOG=clip=debug,iroh=info`).                                                                                                                                                                    |
