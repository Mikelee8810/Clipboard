...
```
  ...
  <verify>
    <automated>cd /home/wuy6/myprojects/Clipboard/src-tauri && cargo test -p uc-cli --lib setup::host_flow:: --test-threads=1 2>&1 | tail -30</automated>
  </verify>
...
```
  ...
  <verify>
    <automated>cd /home/wuy6/myprojects/Clipboard/src-tauri && cargo test -p uc-cli --lib setup::join_flow:: --test-threads=1 2>&1 | tail -30</automated>
  </verify>
...
<verify>
<automated>cd /home/wuy6/myprojects/Clipboard/src-tauri && cargo check -p uc-cli 2>&1 | tail -20</automated>
</verify>
