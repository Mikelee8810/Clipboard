...
| `docker-compose.seq.yml`                             | LAN-accessible Seq instance                   | VERIFIED | Binds to `0.0.0.0:5341:80`, includes `SEQ_FIRSTRUN_ADMINPASSWORD: 'clipboard'`, has development-only warning comment.                                                       |
