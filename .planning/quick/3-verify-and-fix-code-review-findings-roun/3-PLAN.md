...
```rust
/// Magic bytes identifying a Clipboard blob file ("UCBL")
...
<verify>
<automated>cd /home/wuy6/myprojects/Clipboard/src-tauri && cargo test -p uc-app --lib 2>&1 | tail -20</automated>
</verify>
...
<verification>
```bash
cd /home/wuy6/myprojects/Clipboard/src-tauri && cargo test -p uc-app -p uc-infra -p uc-tauri --lib 2>&1 | tail -30
```
