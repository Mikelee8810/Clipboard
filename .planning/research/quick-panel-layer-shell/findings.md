...
- The actual locked build uses Tauri 2.11.5 and Tao 0.35.3; the same hook was verified using the real Wry runtime, not only GTK. Hyprland reports namespace clipboard-quick-panel and the expected 360x580 collapsed geometry.
