...
- Add official Homebrew cask support for installing and updating Clipboard on macOS (#1086)
- Add package-manager packaging for Chocolatey, winget, Scoop, Flathub, and Nix (#1088)
- Add configuration backup and import so you can move an existing Clipboard setup to another device from Settings or first-run setup (#1118)
...
- Fix command-line text output so `clip get` ends cleanly on a terminal line (#1091)
